...
import br from '../../../locales/pt-BR/ProductNameGenerator'
import usa from '../../../locales/en/ProductNameGenerator'
...
export default function ProductNameGenerator() {
  ...
  return (
        <>
            <SEO title={t.seo} desc='generate product name'/>
            <Header/>
                    ...
                    <div className={styles.featureContainer}>
                        <div className={styles.inputs}>
                          <div className={styles.box}>
                            ...
                            <input type='text' onChange={e=>setPrompt(e.target.value)}/>
                            {loading ? <Loading/> : <button onClick={generateNames}>Generate Product Name</button>}
                          </div>
